...
exampleArray.shift();
exampleArray.unshift(1, "string");
console.log(`1. ${exampleArray}`);
// EXERCISE 2
...
console.log(`2.a ${nestedArray}`);
console.log("2.b",nestedArray);
