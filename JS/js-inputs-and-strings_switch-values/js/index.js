...
switchButton.addEventListener("click", () => {
  ...
  // const holder = firstInput.value;      //first = 1
  // firstInput.value = secondInput.value; //first = 2
  // secondInput.value = holder;           //second = 1

  //my solution
  let first = firstInput.value;
  firstInput.value = secondInput.value;
  secondInput.value = first; //here I didn't switch places
...
// }else {firstInput.value=secondInput.value}
